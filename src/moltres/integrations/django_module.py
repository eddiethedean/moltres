...
class MoltresExceptionMiddleware:
    ...
    def _handle_exception(self, request: "HttpRequest", exc: Exception) -> "HttpResponse":
        ...
        if isinstance(exc, DatabaseConnectionError) and not isinstance(exc, ConnectionPoolError):
            return JsonResponse(
                {
        ...
        if isinstance(exc, TransactionError) and not isinstance(exc, QueryTimeoutError):
            return JsonResponse(
                {
        ...
        if isinstance(exc, ExecutionError) and not isinstance(
            exc, (QueryTimeoutError, TransactionError)
        ):
        ...
        if isinstance(exc, ValidationError) and not isinstance(exc, ColumnNotFoundError):
            return JsonResponse(
                {
        ...
        if isinstance(exc, TransactionError) and not isinstance(exc, ExecutionError):
            return JsonResponse(
                {
                    "error": "Transaction error",
                    "message": str(exc.message),
        ...
        if isinstance(exc, MoltresError) and not isinstance(
            exc, (ExecutionError, TransactionError)
        ):
            return JsonResponse(
                {
                    "error": "Moltres error",
...
def get_moltres_db(using: str = "default") -> Any:
