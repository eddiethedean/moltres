...
if TYPE_CHECKING:
    ...
    from ..groupby.async_pandas_groupby import AsyncPandasGroupBy
    from ..columns.async_pandas_indexers import _AsyncLocIndexer, _AsyncILocIndexer


@dataclass(frozen=True)
class AsyncPandasDataFrame(AsyncInterfaceCommonMixin):
    ...
    def crossJoin(self, other: "AsyncPandasDataFrame") -> "AsyncPandasDataFrame":
        ...
        Returns:
            New AsyncPandasDataFrame containing the Cartesian product of rows

        Example:
            >>> df1 = await db.table("table1").pandas()
    ...
    def loc(self) -> "_AsyncLocIndexer":
        ...
        """
        from ..columns.async_pandas_indexers import _AsyncLocIndexer
    ...
    def iloc(self) -> "_AsyncILocIndexer":
        ...
        """
        from ..columns.async_pandas_indexers import _AsyncILocIndexer
    ...
    async def summary(self, *statistics: str) -> "AsyncPandasDataFrame":
        ...
        Returns:
            AsyncPandasDataFrame with summary statistics
